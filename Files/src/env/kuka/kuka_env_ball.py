...
class KUKAenv_ball:
    def __init__(self):
        ...
        self.control_position_z = True # do not control the pose_z via space mouse
        ...
        self.ee_pos_limit_xyz = [0.4, 0.55, -0.18, 0.2, 0.51, 0.72]
        self.ee_fixed_range_xyz = [0.42, 0.48, -0.1, 0.15, 0.56, 0.6]
    ...
    def get_state(self):
        ...
        if self.ee_pose is None or self.object_pose is None or self.qbhand_position is None:
            logger.debug("--------------------------error!---------------------------------------------------------------")
            logger.debug('%s %s %s %s %s %s', "no robot data: ", self.ee_pose is None, " no object data: ", self.object_pose is None, " no qbhand data: ", self.qbhand_position is None)
