...
class Panda():
    def __init__(self):
        ...
        # self.K_ori=30
        self.K_pos=1000
        # self.K_ori=300  # too big...
        self.K_ori=35  #  60 is also big, 40 also have a bit osciallation.., 35 is good
        self.K_ns=10
        self.curr_pos=None
        self.curr_ori=None
    ...
    def home(self):
        ...
        self.go_to_pose(goal, interp_dist = 0.005, interp_dist_polar=0.001)
    ...
    def go_to_pose(self, goal_pose, interp_dist=0.001, interp_dist_polar=0.0001): ##### Are both interpolation distances needed?
